...
// 2 Colemak Mod-DH ANSI https://colemakmods.github.io/mod-dh/gfx/mod_dh_keyb_ansi.png
KEYMAP(
    KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_EQL , ___X___, KC_DEL ,
...
KEYMAP(
    ...
    _______, ___X___, DF(0),   DF(1),   DF(2),   ___X___, ___X___, KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PDOT, _______,          ___X___, 
