...
// 5 FN2
KEYMAP(
    RESET  ,          KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU, KC_MUTE, KC_PSCR, KC_SLCK, KC_PAUS, ___X___, ___X___, ___X___, ___X___, _______, 
    RGB_TOG,          ___X___, KC_HOME, KC_UP  , KC_END , KC_PGUP, ___X___, KC_KP_7, KC_KP_8, KC_KP_9, KC_PMNS, KC_PSLS, ___X___, ___X___, 
    _______,          ___X___, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, ___X___, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS, KC_PAST,          KC_PENT, 
