...
KEYMAP(
    ...
    KC_LCTL,          KC_LGUI, KC_LALT, KC_BSPC,          MO(1)  ,          KC_SPC , MO(2)  , KC_RALT, ___X___, KC_APP ,          KC_RCTL),
...
KEYMAP(
    ...
    _______,          _______, _______, KC_DEL ,          _______,          SH_SPC , TG(2)  , KC_RGUI, ___X___, _______,          _______),
