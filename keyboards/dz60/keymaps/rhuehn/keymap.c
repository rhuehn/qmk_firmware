...
#define MO1_ESC LT(MO(1),KC_ESC)
#define MO1_ENT LT(MO(1),KC_ENT)
...
KEYMAP(
    ...
    MO1_ESC,          KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,          KC_ENT ,
    KC_LSFT, ___X___, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,          ___X___,
    KC_LCTL,          KC_LGUI, KC_LALT, KC_BSPC,          MO1_ENT,          KC_SPC , MO(2)  , KC_RALT, ___X___, KC_APP ,          KC_RCTL),
...
KEYMAP(
    ...
    _______,          _______, _______, KC_DEL ,          _______,          SFT_SPC, TG(2)  , KC_RGUI, ___X___, _______,          _______),
